...
import { Twitter, CaretDown, Upload } from "react-bootstrap-icons";
import "./header.scss";
  ...
  return (
    <Navbar bg="light" expand="lg" sticky="top">
      <div class="container-fluid">
          <SidebarMenu />
          <Navbar.Brand href="/" style={{ marginLeft: "2rem" }} className="mr-auto">
            <Image
              src="https://www.svgrepo.com/show/478565/bible-2.svg"
              alt=""
              width="30"
              height="24"
